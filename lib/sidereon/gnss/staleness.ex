defmodule Sidereon.GNSS.Staleness do
  ...
  @spec select_sp3_over_range([SP3.t()], epoch(), epoch(), Policy.t()) ::
          {:ok, Sp3Selection.t()} | {:error, term()}
  def select_sp3_over_range(products, start_epoch, end_epoch, policy \\ Policy.default())
  ...
  @spec select_ionex_over_range([reference()], epoch(), epoch(), Policy.t()) ::
          {:ok, IonexSelection.t()} | {:error, term()}
  def select_ionex_over_range(handles, start_epoch, end_epoch, policy \\ Policy.default())
  ...
  defp decode_sp3_selection({:error, reason}, _products),
    do: {:error, decode_selection_error(reason)}
  ...
  defp decode_ionex_selection({:error, reason}, _handles),
    do: {:error, decode_selection_error(reason)}
end
