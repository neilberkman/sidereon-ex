defmodule Sidereon.GNSS.QC do
  ...
  `astrodynamics-gnss` Rust core. This module keeps the Elixir API shape,
  ...
  defp decode_raim_result(
         {fault_detected?, test_statistic, threshold, dof, testable?, normalized, worst_sat}
       ) do
    %{
