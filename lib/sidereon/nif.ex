...
# No precompiled NIF binaries are published for this release, so always build
# the crate from source (requires a Rust toolchain on the consumer's machine).
# Precompiled targets + checksum gating return in a later release once CI
# publishes the artifacts to the GitHub release referenced by base_url.
force_build = true
...
defmodule Sidereon.NIF do
  ...
  def angles_phase_angle(_sat_pos, _sun_pos, _observer_pos),
    do: :erlang.nif_error(:nif_not_loaded)
  ...
  def rf_cn0(_eirp_dbw, _fspl_db, _receiver_gt_dbk, _other_losses_db),
    do: :erlang.nif_error(:nif_not_loaded)
  ...
  def rf_dish_gain(_diameter_m, _frequency_hz, _efficiency),
    do: :erlang.nif_error(:nif_not_loaded)
  ...
  def collision_probability(_r1, _v1, _cov1, _r2, _v2, _cov2, _hbr, _method),
    do: :erlang.nif_error(:nif_not_loaded)
  ...
  def geodetic_to_itrs(_latitude_deg, _longitude_deg, _altitude_km),
    do: :erlang.nif_error(:nif_not_loaded)
  ...
  def antex_satellite_antenna(_antennas, _prn, _datetime_tuple),
    do: :erlang.nif_error(:nif_not_loaded)

  def antex_pco(_antenna, _frequency), do: :erlang.nif_error(:nif_not_loaded)

  def antex_pcv(_antenna, _frequency, _zenith_deg, _azimuth_deg),
    do: :erlang.nif_error(:nif_not_loaded)
  ...
  def precise_positioning_solve_float_epochs(
        _handle,
        _epochs,
        _initial_state,
        _weights,
  ...
  def precise_positioning_solve_float(
        _handle,
        _epoch,
        _initial_state,
        _weights,
  ...
  def precise_positioning_solve_fixed_epochs(
        _handle,
        _epochs,
        _initial_state,
        _weights,
  ...
  def precise_positioning_prepare_widelane_fixed_epochs(
        _epochs,
        _wide_lane,
        _policy,
        _slip_options
  ...
  def precise_positioning_split_float_cycle_slip_epochs(_epochs, _slip_options),
    do: :erlang.nif_error(:nif_not_loaded)
  ...
  def sp3_state(_handle, _system_letter, _prn, _epoch_index),
    do: :erlang.nif_error(:nif_not_loaded)
  ...
  def broadcast_comparison(_broadcast, _precise, _satellites, _epochs, _velocity_half_s),
    do: :erlang.nif_error(:nif_not_loaded)
  ...
  def velocity_doppler_to_range_rate(_doppler_hz, _carrier_hz),
    do: :erlang.nif_error(:nif_not_loaded)

  def velocity_range_rate_to_doppler(_range_rate_m_s, _carrier_hz),
    do: :erlang.nif_error(:nif_not_loaded)
  ...
  def geometry_dop(_rows, _receiver_lat_rad, _receiver_lon_rad),
    do: :erlang.nif_error(:nif_not_loaded)

  def sp3_geometry_visible(
        _handle,
        _receiver_ecef_m,
        _jd_whole,
        _jd_fraction,
  ...
  def rinex_clock_clock_s(_series, _satellite_id, _datetime_tuple),
    do: :erlang.nif_error(:nif_not_loaded)
  ...
  def rinex_obs_band_frequency_hz(_system, _band, _channel),
    do: :erlang.nif_error(:nif_not_loaded)
  ...
  def frequencies_rinex_band_frequency_hz(_system, _band, _glonass_channel),
    do: :erlang.nif_error(:nif_not_loaded)

  def frequencies_rinex_band_wavelength_m(_system, _band, _glonass_channel),
    do: :erlang.nif_error(:nif_not_loaded)
  ...
  def signal_correlator_correlate(
        _iq,
        _prn,
        _sample_rate_hz,
        _doppler_hz,
  ...
  def signal_coherent_loss(_freq_error_hz, _integration_time_s),
    do: :erlang.nif_error(:nif_not_loaded)

  def signal_coherent_loss_db(_freq_error_hz, _integration_time_s),
    do: :erlang.nif_error(:nif_not_loaded)
  ...
  def reduced_orbit_piecewise_fit(
        _samples,
        _scale,
        _model,
        _window_start,
  ...
  def rtk_baseline_reference_satellites(_base_m, _epochs, _reference),
    do: :erlang.nif_error(:nif_not_loaded)

  def rtk_apply_elevation_mask(_base_m, _epochs, _mask_deg),
    do: :erlang.nif_error(:nif_not_loaded)

  def rtk_smooth_code_epochs(_epochs, _hatch_window_cap), do: :erlang.nif_error(:nif_not_loaded)

  def rtk_prepare_cycle_slip_epochs(_epochs, _policy), do: :erlang.nif_error(:nif_not_loaded)

  def rtk_prepare_dual_cycle_slip_epochs(
        _epochs,
        _policy,
        _gf_threshold_m,
  ...
  def rtk_estimate_wide_lanes(
        _epochs,
        _reference_satellite_id,
        _min_epochs,
        _tolerance_cycles,
        _skip_short_fragments
      ), do: :erlang.nif_error(:nif_not_loaded)

  def rtk_ionosphere_free_baseline_epochs(
        _base_m,
        _initial_baseline_m,
        _epochs,
        _reference_satellite_id,
  ...
  def rtk_solve_fixed_baseline(
        _epochs,
        _base,
        _ambiguity_ids,
        _float_baseline_m,
        _float_ambiguities_m,
        _float_covariance_m,
        _wavelengths_m,
        _offsets_m,
  ...
  def rtk_solve_fixed_baseline_validated(
        _epochs,
        _base,
        _ambiguity_ids,
        _wavelengths_m,
  ...
  def reduced_orbit_piecewise_position(
        _window_start,
        _window_end,
        _segment_s,
        _segments,
  ...
  def reduced_orbit_piecewise_select_segment(
        _window_start,
        _window_end,
        _segment_s,
        _segments,
  ...
  def reduced_orbit_piecewise_drift(
        _window_start,
        _window_end,
        _segment_s,
        _segments,
  ...
  def staleness_select_sp3(_handles, _requested_epoch_j2000_s, _max_staleness_s),
    do: :erlang.nif_error(:nif_not_loaded)

  def staleness_select_sp3_over_range(
        _handles,
        _start_epoch_j2000_s,
        _end_epoch_j2000_s,
        _max_staleness_s
      ), do: :erlang.nif_error(:nif_not_loaded)
  ...
  def staleness_select_ionex_over_range(
        _handles,
        _start_epoch_j2000_s,
        _end_epoch_j2000_s,
        _max_staleness_s
  ...
  def qc_sigmas(_entries, _a_m, _b_m, _model, _cn0, _cn0_scale_m2),
    do: :erlang.nif_error(:nif_not_loaded)

  def qc_weight_vector(_entries, _a_m, _b_m, _model, _cn0, _cn0_scale_m2),
    do: :erlang.nif_error(:nif_not_loaded)
  ...
  def iono_free_phase(_phase1_m, _phase2_m, _f1_hz, _f2_hz),
    do: :erlang.nif_error(:nif_not_loaded)

  def iono_free_phase_cycles(_phi1_cycles, _phi2_cycles, _f1_hz, _f2_hz),
    do: :erlang.nif_error(:nif_not_loaded)
  ...
  def carrier_phase_narrow_lane_code(_p1_m, _p2_m, _f1_hz, _f2_hz),
    do: :erlang.nif_error(:nif_not_loaded)
  ...
  def carrier_phase_code_minus_carrier(_p_m, _phi_cycles, _f_hz),
    do: :erlang.nif_error(:nif_not_loaded)

  def carrier_phase_detect_cycle_slips(
        _arc,
        _gf_threshold_m,
        _mw_threshold_cycles,
        _min_arc_gap_s
