defmodule Sidereon.RFTest do
  ...
  describe "fspl/2" do
    ...
    test "GEO satellite at 36000 km, Ku-band" do
      ...
      fspl = Sidereon.RF.fspl(36_000.0, 12_000.0)
  ...
  describe "fspl_batch/2" do
    test "matches scalar results element by element" do
      distances = [800.0, 1200.0, 2000.0]

      assert Sidereon.RF.fspl_batch(distances, 1616.0) ==
               Enum.map(distances, &Sidereon.RF.fspl(&1, 1616.0))
    end
  end
  ...
  describe "link_margin_batch/1" do
    test "matches scalar results element by element" do
      budgets = [
        %{
          eirp_dbw: 0.0,
        ...
        %{
          ...
          other_losses_db: 4.0,
          required_cn0_dbhz: 36.0
        }
      ]

      assert Sidereon.RF.link_margin_batch(budgets) ==
               Enum.map(budgets, &Sidereon.RF.link_margin/1)
    end
  end
