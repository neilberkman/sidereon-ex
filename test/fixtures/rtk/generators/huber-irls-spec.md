...
`Sidereon.GNSS.Positioning.solve/4`. Additive, default OFF: with `:huber` unset the
...
(`:huber` off) must produce byte-identical numbers to current sidereon 0.25.0 on the
