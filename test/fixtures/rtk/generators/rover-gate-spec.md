...
Status: PRE-REGISTERED 2026-06-12, BEFORE any sidereon run on these arcs.
...
CORS base nearest the route, full provenance) BEFORE sidereon runs on it.
...
- Comparative bar: sidereon median <= demo5 median x 1.25, and sidereon p95 <=
...
Any epoch sidereon reports as :fixed must come from a population whose error
