...
velocity and Doppler-aided positioning in the Elixir reference layer of sidereon.

## What is under test

`Sidereon.GNSS.Velocity.solve/5` with `observable: :doppler`: receiver velocity and
...
oracle-supported gain to harden, and SPP (`Sidereon.GNSS.Positioning.solve`) is the
