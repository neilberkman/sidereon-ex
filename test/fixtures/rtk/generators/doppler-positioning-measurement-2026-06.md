...
Doppler-aided positioning in the Elixir reference layer of sidereon.
...
No `Sidereon.GNSS.Velocity` code change. `Velocity.solve/5` already implements the
...
INVESTIGATED, declined as a new capability. SPP (`Sidereon.GNSS.Positioning.solve`) is
