defmodule HuberIrls202606 do
  ...
  defp verdict(bare, huber, _demo5, n, huber_only_failures) do
    ...
    %{
      ...
      huber_only_failures: huber_only_failures,
      median_non_regress?: powered? and no_availability_regress? and huber.median_3d_m <= bare.median_3d_m,
  ...
  defp pool(arcs) do
    ...
    %{
      ...
      all_off_identical?: powered != [] and Enum.all?(powered, &(Map.get(&1, :identical_off) == true)),
