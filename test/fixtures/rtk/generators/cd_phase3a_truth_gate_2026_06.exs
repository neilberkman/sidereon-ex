defmodule CDPhase3aTruthGate202606 do
  ...
  def main(args) do
    ...
    cells = [
      ...
      {"b", "batch float, with corrections", :float, float_opts ++ [receiver_antenna_corrections: corrections]},
      {"c", "batch fixed, no corrections", :fixed, fixed_opts},
      {"d", "batch fixed, with corrections", :fixed, fixed_opts ++ [receiver_antenna_corrections: corrections]}
    ]
